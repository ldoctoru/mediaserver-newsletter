...
# Handle alternate config extension
...
# If no config, copy default and exit with info
...
# Optional: show which server type is in use
echo "Starting newsletter for server type: ${SERVER_TYPE:-jellyfin}"

###
# Switch to user 1001 and run app
###
